package com.project.puk.service
...
class MediaNotificationService : MediaBrowserServiceCompat() {
    ...
    companion object {
        ...
        private const val ACTION_PLAY_PAUSE = "com.project.puk.ACTION_PLAY_PAUSE"
        private const val ACTION_NEXT = "com.project.puk.ACTION_NEXT"
        private const val ACTION_PREV = "com.project.puk.ACTION_PREV"
        private const val ACTION_FAVORITE = "com.project.puk.ACTION_FAVORITE"
    ...
    override fun onCreate() {
        ...
        // Initialize MediaSession with starting state and metadata
        updatePlaybackState()
        updateMetadata()
    ...
    private fun updateMetadata() {
        val builder = MediaMetadataCompat.Builder()
            .putString(MediaMetadataCompat.METADATA_KEY_TITLE, currentTitle.ifEmpty { "SpotiPuk" })
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, currentArtist.ifEmpty { "Spotify Player" })
    ...
    private fun buildNotification(): Notification {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText(currentArtist.ifEmpty { "Spotify Player" })
            .setSubText("SpotiPuk")
